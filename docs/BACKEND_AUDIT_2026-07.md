...
| renderer.py:330 | `for_text`'s reverse colour map tests the wrong variable and is always `{}` (verified by execution): MCP `get_display` leaks raw U+E000-06 PUA chars instead of 🟥 tiles | S |
